    ...
    init {
        viewModelScope.launch {
            ...
            for (i in 0..5) {
                ...
                caffsList.add(
                    Caff(
                        i.toLong(), LocalDateTime.now(), "AdrianWolve",
